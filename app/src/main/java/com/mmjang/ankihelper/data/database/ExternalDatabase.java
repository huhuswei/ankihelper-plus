...
public class ExternalDatabase {
    ...
    private static final String MDL_CSS = "css";
    private static final String MDL_JS = "js";
...
//        );
    ...
    private static String[] fromFieldsString(String fieldsString){
        String[] dictFields = fieldsString.split(SPLITTER);
        return dictFields;
    }
    ...
    public void addMdictInformation(int id, String name, String lang, String[] elements, String description, String tmpl, int order){
        ...
        values.put(MDL_CSS, name.substring(0,name.lastIndexOf(".mdx")) + ".css");
        values.put(MDL_JS, name.substring(0,name.lastIndexOf(".mdx")) + ".js");
    ...
    public void addMdictInformation(MdictInformation mdictInformation){
        ...
        values.put(MDL_CSS, mdictInformation.getDictCss());
        values.put(MDL_JS, mdictInformation.getDictJs());
        ...
        values.put(MDL_REGEX, mdictInformation.getCustomFields());
...
//        values.put(MDL_ORDER, mdictInformation.getOrder());
    ...
    public MdictInformation getMdictInfoById(int dictId){
        Cursor cursor = mDatabase.query(
                TB_MDICT,
                new String[] {MDL_ID, MDL_NAME, MDL_CSS, MDL_JS, MDL_DESCRIPTION, MDL_LANG, MDL_TMPL, MDL_REGEX, MDL_ELEMENTS, MDL_ORDER},
                MDL_ID + "=" + dictId,
                null,
                null,
                null,
        ...
        while(cursor.moveToNext()){
            mdictInformation = new MdictInformation(
                    ...
                    cursor.getString(6),
                    cursor.getString(7),
                    fromFieldsString(cursor.getString(8)),
                    cursor.getInt(9)
            );
        }
