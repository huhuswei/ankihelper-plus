...
import com.knziha.plod.PlainDict.MdictServerOyster.PlainDictAppOptions;
...
//		if(!opt.GetRegexSearchEngineCaseSensitive())
	...
	public final double getFileSizeProperty() {
		return (f.length()/1024.0/1024);
	}
	public final boolean getFormationProperty() {
		return tmpIsFilter;
	}
