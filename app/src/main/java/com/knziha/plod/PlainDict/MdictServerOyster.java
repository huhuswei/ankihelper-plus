...
//	public PlainDictionaryPcJFX a;
	public static class PlainDictAppOptions implements AppOptions{
	public int currentDisplaying = 0;
	public int adapter_idx = 0;
	public String record_for_mirror = "mirror";
	...
	private PlainDictAppOptions a;
	private JAIConverter tiffConverter;

//	public MdictServerOyster(int port, PlainDictionaryPcJFX _a, PlainDictAppOptions _opt)
	public MdictServerOyster(int port, String k /*PlainDictionaryPcJFX _a*/, PlainDictAppOptions _opt) throws IOException {
		super(port, _opt);
//		a = _a;
//		MdbServerLet = _a;
		...
		setOnMirrorRequestListener((uri, mirror) -> {
			...
			String key = k;//a.etSearch.getText();
			try {
